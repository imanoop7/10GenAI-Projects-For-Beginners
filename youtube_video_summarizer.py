# required pacakage- openai, youtube_transcript_api
...
def gpt3_completion(prompt, model='gpt-35-turbo', temp=0.5, top_p=1.0, tokens=500, freq_pen=0.25, pres_pen=0.0, stop=['\n']):
    max_retry = 3
    retry = 0
    while True:
        try:
...
url = 'https://www.youtube.com/watch?v=yfFeGC_NSNA&t=4s'
